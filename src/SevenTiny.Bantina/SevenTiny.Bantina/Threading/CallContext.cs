...
namespace SevenTiny.Bantina.Threading
{
    /// <summary>
    ...
    public static class CallContext
    {
        ...
        /// <summary>
        /// Remove data of the key from store if exist.
        /// </summary>
        /// <param name="name">The name of the item in the call context.</param>
        public static void Remove(string name) => state.TryRemove(name, out AsyncLocal<object> value);
        /// <summary>
        /// Clear all of the keys from store.
        /// </summary>
